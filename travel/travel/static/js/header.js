...
const phone_input_register = document.querySelector('#phone-input-register');

if(phone_input_register){
    phone_input_register.addEventListener('input', ()=>{
        let value_current = phone_input_register.value.slice(2);
        phone_input_register.value = '+7' + value_current;
    })
}
